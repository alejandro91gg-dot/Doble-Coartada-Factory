...
description: Audits character continuity in the active case across identity, relationships, knowledge, statements, whereabouts, motives, roles, and document appearances. Use whenever a character fact or character-linked document changes.
---
...
- relationships;
- motive/pressure;
- knowledge state by time;
- REAL/CLAIMED/PROVABLE whereabouts;
- lies/secrets;
- access;
- evidence links;
...
1. Compare changed attributes against the ledger.
2. Check knowledge causality.
3. Check relationship continuity across canon, statements, evidence, and player-facing material.
4. Route whereabouts through chronology/alibi audits.
5. Route evidence-linked changes through evidence-dependency audit.
6. Trace all affected mentions before consolidation.

## Output

`Person ID | Attribute | Authoritative value | Proposed/current value | Affected docs/evidence/timelines | Conflict? | Required action`

Conclude `CHARACTER CONTINUITY PASS` or `FAIL`.
